                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <body onunload="responsiveVoice.cancel();">
                                                <button class="btn btn-primary"
                                                    onclick="responsiveVoice.speak('Nomor Antrian {{ $antrian_masuk->kode }} Menuju ke loket {{ $antrian_masuk->antrian->nama_layanan }}', 'Indonesian Female', {rate: 0.8});"
                                                    onblur="responsiveVoice.cancel();" type="button" value="Play"><i
                                        ...
                                        <td>
                                            ...
                                            <form id="{{ $antrian_masuk->id }}"
                                                action="{{ route('antrian.ada', $antrian_masuk->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('PUT')
                                                <button type="submit" class="btn btn-success">
                                                    <i class="bi bi-check2-all"></i> Dilayani
                                                </button>
                                            </form>
                                            ...
                                            <form id="{{ $antrian_masuk->id }}"
                                                ...
                                                <button type="submit" class="btn btn-danger"><i
                                                        class="bi bi-skip-forward"></i> Tidak Datang</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endif
